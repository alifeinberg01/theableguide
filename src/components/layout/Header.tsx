...
const nav = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Airports & Flying", href: "/resources?category=Airports%20%26%20Flying" },
      { label: "Theme Parks", href: "/resources?category=Theme%20Parks" },
      { label: "Resorts & Hotels", href: "/resources?category=Resorts%20%26%20Hotels" },
      { label: "Destinations", href: "/resources?category=Destinations" },
      { label: "Universal Tools", href: "/resources?category=Universal%20Tools" },
      { label: "Preparation", href: "/resources?category=Preparation" },
    ],
  },
